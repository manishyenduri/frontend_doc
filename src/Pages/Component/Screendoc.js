...
class Screendoc extends React.Component {
...
{this.state.modalPopup == true &&
        ...
        <div className="row" style={{marginTop:'20px',width:'90%',marginLeft:'5%'}}>
            ...
            <div className="col-md-2">
                <button style={{padding:'10px 20px',border:'none',fontSize:'15px',borderRadius:'10px',backgroundColor:'#9B1E28',color:'white',border:'2px solid #9B1E28'}} onClick={() => this.handleScreenChng('Screen-Document')}>Screened Documents</button>
            </div>
            <div className="col-md-2">
...
const mapStateToProps = (state) => {
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(Screendoc)
