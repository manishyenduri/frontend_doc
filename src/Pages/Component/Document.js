      ...
      <ToastContainer style={{fontSize:'15px'}}/>
        ...
        <div className="row" style={{marginTop:'20px',width:'90%',marginLeft:'5%'}}>
            <div className="col-md-2" style={{display:'flex'}}>
                ...
                <button style={{padding:'10px 9px',border:'none',borderRadius:'10px',backgroundColor:'#9B1E28',color:'white',fontSize:'15px'}}>Mandatory Document</button>
            </div>
            <div className="col-md-2">
                <button style={{padding:'10px 20px',border:'none',borderRadius:'10px',backgroundColor:'white',fontSize:'15px',color:'#9B1E28',border:'2px solid #9B1E28'}} onClick={() => this.handleScreenChng('Other-Document')}>Other Document</button>
            </div>
            <div className="col-md-2">
                <button style={{padding:'10px 20px',border:'none',borderRadius:'10px',backgroundColor:'white',fontSize:'15px',color:'#9B1E28',border:'2px solid #9B1E28'}} onClick={() => this.handleScreenChng('Screen-Document')}>Screened Documents</button>
            </div>
            <div className="col-md-2">
                <button style={{padding:'10px 20px',border:'none',borderRadius:'10px',backgroundColor:'white',fontSize:'15px',color:'#9B1E28',border:'2px solid #9B1E28'}} onClick={() => this.handleScreenChng('Classified-Document')}>Classified Document</button>
            </div>
            <div className="col-md-2">
                <button style={{padding:'10px 20px',border:'none',borderRadius:'10px',backgroundColor:'white',fontSize:'15px',color:'#9B1E28',border:'2px solid #9B1E28'}} onClick={() => this.handleScreenChng('Missing-Document')}>Missing Document</button>
            </div>
            <div className="col-md-2">
                <button style={{padding:'10px 15px',border:'none',borderRadius:'10px',backgroundColor:'white',fontSize:'15px',color:'#9B1E28',border:'2px solid #9B1E28'}}>Unclassified Document</button>
            </div>
        </div>
        <div className="row" style={{marginTop:'20px',width:'90%',marginLeft:'5%'}}>
            <div className="col-md-2">
                <a style={{borderBottom: this.state.setValue == 'first' ? '2px solid black' : 'none',fontWeight:this.state.setValue === "first" ? 'bold':'300'}} onClick={() => this.handletab('first')}>Customer request Letter</a>
            </div>
            <div className="col-md-1">
                <a style={{borderBottom: this.state.setValue == 'Second' ? '2px solid black' : 'none',fontWeight:this.state.setValue !== "first" ? 'bold':'300'}} onClick={() => this.handletab('Second')}>Invoice</a>
            </div>
            <div className="col-md-5 offset-md-4">
                    <p style={{border:'2px solid black',padding:'11px 20px',borderRadius:'10px',marginLeft:'25%',width:'70%'}}>UCIC No. <span style={{fontWeight:'bold'}}>{localStorage.getItem('ucic')} </span> &nbsp; <span style={{padding:'5px 10px',backgroundColor:'#c5d8ee',color:'#2963a5',borderRadius:'5px'}}>Track id: {localStorage.getItem('tackid')}</span></p>                
            </div>
            <hr></hr>
        </div>        
        ...
        :
        <div className="row" id="overflow" style={{marginTop:'20px',width:'90%',marginLeft:'5%'}}>
            <div className="col-md-4">
                {this.state.setValue === "first" &&
                <div className="row" style={{width:'95%',padding:'20px 20px',boxShadow: 'rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px'}}>
